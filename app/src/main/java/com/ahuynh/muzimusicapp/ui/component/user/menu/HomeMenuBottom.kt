package com.ahuynh.muzimusicapp.ui.component.user.menu
...
import com.ahuynh.muzimusicapp.ui.component.user.home.HomeViewModel
...
class HomeMenuBottom : BottomSheetDialogFragment() {
    companion object {
        const val TAG = "HomeMenuBottom"
    }
