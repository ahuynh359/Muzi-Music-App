...
class ManageAlbumViewModel @Inject constructor(
    ...
    fun createAlbum(name: String, avatar: File) {
        ...
        parentJob = viewModelScope.launch {
            ...
            createAlbumStatus.postValue(result is Response.Success)
        }
        registerEventParentJobFinish()
    }
    ...
    fun updateAlbum(id: Long, str: String) {
        ...
        parentJob = viewModelScope.launch {
            ...
            updateAlbumStatus.postValue(result is Response.Success)
        }
        registerEventParentJobFinish()
    }
    ...
    fun deleteAlbum(id: Long) {
        ...
        parentJob = viewModelScope.launch {
            ...
            deleteAlbumStatus.postValue(result is Response.Success)
        }
